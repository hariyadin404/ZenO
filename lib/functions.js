...
const donoHub = cfonts.render((`Bot criado por...`), {
	font: 'chrome',
	align: 'center',
	gradient: ["#F5F5F5","#696969"],
	lineHeight: 3
});

const lucasLiomHub = cfonts.render((`LUCAS-LIOM`), {
	font: 'chrome',
	align: 'center',
	gradient: ["red","blue"],
	lineHeight: 3
...
const linkHub = cfonts.render((`Me segue no GitHub: https://github.com/Lucas-LIOM`), {
	font: 'console',
    gradient: ["red","blue"],
    lineHeight: 3
  });

const banner = cfonts.render((`Zen/O`), { 
    font: 'block',
    align: 'center',
    gradient: ["#696969","#F5F5F5"],
    lineHeight: 3
  });


module.exports = { wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, donoHub, close, linkHub, lucasLiomHub }
